...
Напишите функцию, называемую `arryintersection`, которая принимает два массива и возвращает массив, содержащий пересечение двух входных массивов (то есть общие элементы, которые появляются в обоих массивах).
### Function Signature
