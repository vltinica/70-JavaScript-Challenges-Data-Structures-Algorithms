...
Напишите функцию, называемую «FindMissingNumber», которая принимает множество уникальных чисел от 1 до N (включительно), где отсутствует одно число.Он должен вернуть недостающий номер.
...
- Если пройден пустой массив, он должен вернуть `1`
- Если ничего не передано, это должно вернуть «неопределенные»
...
- Рассчитайте сумму чисел от 1 до N (включительно).Формула для этого - `n * (n + 1) / 2`.`n` - это длина массива плюс 1.
- Рассчитайте сумму чисел в массиве.
- Вычтите сумму чисел в массиве от суммы чисел от 1 до N (включительно).
- Вы можете использовать для цикла или метод уменьшения для расчета суммы чисел в массиве.Мы сосредоточимся на таких методах, как уменьшение в следующем разделе, но я все равно покажу вам обоих способов.
